...
<body>
	...
	<h1 class="centerH">
		Installation Settings for <span class="titProduct"></span>&nbsp;<span
			class="titProduct"></span>
	</h1>
	<div class="panel">
		...
		<div class="row">
			...
			function createConfigFile($cfgFile,$dbConn){
				...
				$config .= "\n";
				$config .= "// Uncomment the line bellow in order to show comments form other products with the same version from the same database"."\n";
				$config .= "//define('__SHARE_WITH__',\"'oxygenXMLEditor','XMLAuthor'\");"."\n";
				$config .= "\n";
			...
			function installProduct($dbConnectionInfo){
				...
				$db->run("INSERT INTO `webhelp` (`parameter`, `value`, `product`, `version`) VALUES
						...
						('path','".Utils::getParam($_POST, 'baseUrl')."','".$productId."','".$productVersion."');");
				$db->Close();
			}
